...
addon_info = {
	...
	"addon_name": "musescore",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	"addon_summary": _("musescore"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	"addon_description": _("""An NVDA Add_on for extending NVDA's functionality for Musescore; a popular free music notation software."""),
	# version
	"addon_version": "0.1.0",
	# Author(s)
	"addon_author": "Umit Erdem YIGITOGLU <erdemyigitoglu@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": None,
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/erdemYigitoglu/musescoreAdOn",
	...
	"addon_license": "GPL 3.0.0",
	# URL for the license document the ad-on is licensed under
	"addon_licenseURL": "https://github.com/erdemYigitoglu/musescoreAdOn/blob/main/LICENSE",
}
